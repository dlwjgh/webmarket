    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="/admin/notifyHistory" class="nav-item nav-link active"><i class="fa-solid fa-list-ul me-2"></i>상품 글 신고내역</a>                <a href="/admin/boardNotifyHistory" class="nav-item nav-link"><i class="fa-solid fa-list-ul me-2"></i>게시글 신고내역</a>
